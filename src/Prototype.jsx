...
function Prototype() {
  ...
  function NewTask({id}){
    ...
    const placeHolderWeekdays = [];
    amoutnsPerDay.forEach((key) => {
      if(amountPerDay[key] === 0){
        placeHolderWeekdays.push(amoutnsPerDay[key]);
      }
      else{
        placeHolderWeekdays.push(key);
      }
    })
    return(
      <div id={taskID} className="divTask">
        ...
        <input className='inpDayAmount' placeholder={placeHolderWeekdays[0]} onChange={onInpAmountChange}></input> 
        <input className='inpDayAmount' placeholder={placeHolderWeekdays[1]} onChange={onInpAmountChange}></input> 
        <input className='inpDayAmount' placeholder={placeHolderWeekdays[2]} onChange={onInpAmountChange}></input> 
        <input className='inpDayAmount' placeholder={placeHolderWeekdays[3]} onChange={onInpAmountChange}></input>
        <input className='inpDayAmount' placeholder={placeHolderWeekdays[4]} onChange={onInpAmountChange}></input>
        <input className='inpDayAmount' placeholder={placeHolderWeekdays[5]} onChange={onInpAmountChange}></input> 
        <input className='inpDayAmount' placeholder={placeHolderWeekdays[6]} onChange={onInpAmountChange}></input>
        <br></br>
